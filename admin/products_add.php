                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="products.php"> <div class="sb-nav-link-icon"><i class="fas fa-solar-panel"></i></div>
                                Produk
                            </a>
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseKalkulator" aria-expanded="false" aria-controls="collapseKalkulator">
                                <div class="sb-nav-link-icon"><i class="fas fa-cogs"></i></div>
                                Setting Kalkulator
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseKalkulator" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <form action="product_add.php" method="POST">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="name" name="name" type="text" placeholder="Cth: The SunDial Starter" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="subtitle">Subjudul</label>
                                            <input class="form-control" id="subtitle" name="subtitle" type="text" placeholder="Cth: (2-3 kWp)">
                                        </div>
                                    </div>
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="slug">Slug (untuk URL)</label>
                                            <input class="form-control" id="slug" name="slug" type="text" placeholder="cth: the-sundial-starter" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="image_url">URL Gambar</label>
                                            <input class="form-control" id="image_url" name="image_url" type="text" placeholder="Cth: ../img/catalog-product1.png" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="small mb-1" for="description">Deskripsi</label>
                                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Deskripsi singkat produk..."></textarea>
                                    </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="summary_feature_1" name="summary_feature_1" type="text" placeholder="Cth: Small Investment, Big Savings">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="small mb-1" for="summary_feature_2">Fitur Ringkas 2</label>
                                            <input class="form-control" id="summary_feature_2" name="summary_feature_2" type="text" placeholder="Cth: Quick Installation">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="key_features_json" name="key_features_json" rows="5" placeholder='[{"title": "Judul Fitur 1", "description": "Deskripsi fitur 1."}, {"title": "Judul Fitur 2", "description": "Deskripsi fitur 2."}]'></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="small mb-1" for="specifications_json">Spesifikasi (JSON)</label>
                                        <textarea class="form-control" id="specifications_json" name="specifications_json" rows="5" placeholder='[{"icon_class": "icon-apa", "title": "Judul Spek 1", "subtitle": "Subjudul spek 1."}, {"icon_class": "icon-lain", "title": "Judul Spek 2", "subtitle": "Subjudul spek 2."}]'></textarea>
                                    </div>
