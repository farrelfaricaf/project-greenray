                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="faq_add.php" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    ...
                                    if ($result_faqs && $result_faqs->num_rows > 0) {
                                        ...
                                        while ($row = $result_faqs->fetch_assoc()) {
                                            ...
                                            echo '<td>
                                                <a href="faq_edit.php?id=' . $row['id'] . '" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="faq_delete.php?id=' . $row['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus FAQ ini?\');">Hapus</a>
                                            </td>';
                                            echo '</tr>';
                                        }
                                    } else {
