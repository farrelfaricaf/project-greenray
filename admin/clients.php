                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="client_add.php" class="btn btn-primary btn-sm">
                                    ...
                                    if ($result_clients && $result_clients->num_rows > 0) {
                                        ...
                                        while ($row = $result_clients->fetch_assoc()) {
                                            ...
                                            echo '<td>
                                                ...
                                                <a href="client_delete.php?id=' . $row['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus klien ini?\');">Hapus</a>
                                            </td>';
                                            echo '</tr>';
                                        }
                                    } else {
